...
#ifndef __XEDIT_WINDOW_PRIVATE_H__
#define __XEDIT_WINDOW_PRIVATE_H__
...
/* WindowPrivate is in a separate .h so that we can access it from xedit-commands */

struct _XeditWindowPrivate
{
	GtkWidget      *notebook;
	...
	GtkWidget      *menubar;
	XeditToolbarSetting toolbar_style;
...
#endif  /* __XEDIT_WINDOW_PRIVATE_H__  */
