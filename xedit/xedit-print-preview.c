...
struct _XeditPrintPreviewPrivate
{
...
#if GTK_CHECK_VERSION (3, 0, 0)
G_DEFINE_TYPE (XeditPrintPreview, xedit_print_preview, GTK_TYPE_BOX)
#else
G_DEFINE_TYPE (XeditPrintPreview, xedit_print_preview, GTK_TYPE_VBOX)
#endif

static void 
xedit_print_preview_get_property (GObject    *object,
				  guint       prop_id,
				  GValue     *value,
				  GParamSpec *pspec)
{
	//XeditPrintPreview *preview = XEDIT_PRINT_PREVIEW (object);
...
static void 
xedit_print_preview_set_property (GObject      *object,
				  guint	        prop_id,
				  const GValue *value,
				  GParamSpec   *pspec)
{
...
static void
xedit_print_preview_finalize (GObject *object)
{
	//XeditPrintPreview *preview = XEDIT_PRINT_PREVIEW (object);

	G_OBJECT_CLASS (xedit_print_preview_parent_class)->finalize (object);
}

static void
xedit_print_preview_grab_focus (GtkWidget *widget)
{
	XeditPrintPreview *preview;

	preview = XEDIT_PRINT_PREVIEW (widget);

	gtk_widget_grab_focus (GTK_WIDGET (preview->priv->layout));
}

static void						 
xedit_print_preview_class_init (XeditPrintPreviewClass *klass)
{
	...
	object_class->set_property = xedit_print_preview_set_property;
	object_class->finalize = xedit_print_preview_finalize;

	widget_class->grab_focus = xedit_print_preview_grab_focus;

	g_type_class_add_private (object_class, sizeof(XeditPrintPreviewPrivate));	
}

static void
update_layout_size (XeditPrintPreview *preview)
{
...
static void
set_rows_and_cols (XeditPrintPreview *preview,
		   gint	              rows,
		   gint	              cols)
{
...
static double
get_paper_width (XeditPrintPreview *preview)
{
	return preview->priv->paper_w * preview->priv->dpi;
}

static double
get_paper_height (XeditPrintPreview *preview)
{
...
static void
update_tile_size (XeditPrintPreview *preview)
{
	XeditPrintPreviewPrivate *priv;	
	gint w, h;
...
static void
set_zoom_factor (XeditPrintPreview *preview,
		 double	            zoom)
{
	XeditPrintPreviewPrivate *priv;	
...
static void
set_zoom_fit_to_size (XeditPrintPreview *preview)
{
	XeditPrintPreviewPrivate *priv;	
	double width, height;
...
static void
zoom_in (XeditPrintPreview *preview)
{
...
static void
zoom_out (XeditPrintPreview *preview)
{
	set_zoom_factor (preview,
...
static void
goto_page (XeditPrintPreview *preview, gint page)
{
	gchar c[32];
...
static void
on_1x1_clicked (GtkMenuItem *i, XeditPrintPreview *preview)
{
	set_rows_and_cols (preview, 1, 1);
}

static void
on_1x2_clicked (GtkMenuItem *i, XeditPrintPreview *preview)
{
	set_rows_and_cols (preview, 1, 2);
}

static void
on_2x1_clicked (GtkMenuItem *i, XeditPrintPreview *preview)
{
	set_rows_and_cols (preview, 2, 1);
}

static void
on_2x2_clicked (GtkMenuItem *i, XeditPrintPreview *preview)
{
...
static void
create_bar (XeditPrintPreview *preview)
{
	XeditPrintPreviewPrivate *priv;
	GtkWidget *toolbar;
	GtkToolItem *i;
...
static gint
get_first_page_displayed (XeditPrintPreview *preview)
{
	XeditPrintPreviewPrivate *priv;
...
static gint
get_page_at_coords (XeditPrintPreview *preview,
		    gint               x,
		    gint               y)
{
	XeditPrintPreviewPrivate *priv;
...
static void
create_preview_layout (XeditPrintPreview *preview)
{
	XeditPrintPreviewPrivate *priv;
	AtkObject *atko;
...
static void
xedit_print_preview_init (XeditPrintPreview *preview)
{
	XeditPrintPreviewPrivate *priv;
	
	priv = G_TYPE_INSTANCE_GET_PRIVATE (preview, 
					    XEDIT_TYPE_PRINT_PREVIEW,
					    XeditPrintPreviewPrivate);
...
static double
get_screen_dpi (XeditPrintPreview *preview)
{
	GdkScreen *screen;
	double dpi;
...
static void
set_n_pages (XeditPrintPreview *preview,
	     gint               n_pages)
{
	gchar *str;
...
static void
update_paper_size (XeditPrintPreview *preview,
...
static cairo_surface_t *
create_preview_surface (XeditPrintPreview *preview,
			double	  *dpi_x,
			double	  *dpi_y)
{
    GtkPageSetup *page_setup;
...
GtkWidget *
xedit_print_preview_new (GtkPrintOperation        *op,
			 GtkPrintOperationPreview *gtk_preview,
			 GtkPrintContext          *context)
{
	XeditPrintPreview *preview;
	...
	preview = g_object_new (XEDIT_TYPE_PRINT_PREVIEW, NULL);
