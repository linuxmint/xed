...
struct _XeditTextRegion {
	GtkTextBuffer *buffer;
	GList         *subregions;
	guint32        time_stamp;
};

typedef struct _XeditTextRegionIteratorReal XeditTextRegionIteratorReal;

struct _XeditTextRegionIteratorReal {
...
/* Find and return a subregion node which contains the given text
   ...
   subregion */
static GList * 
find_nearest_subregion (XeditTextRegion     *region,
...
XeditTextRegion *
xedit_text_region_new (GtkTextBuffer *buffer)
{
	XeditTextRegion *region;

	g_return_val_if_fail (buffer != NULL, NULL);

	region = g_new (XeditTextRegion, 1);
...
void 
xedit_text_region_destroy (XeditTextRegion *region, gboolean delete_marks)
{
...
GtkTextBuffer *
xedit_text_region_get_buffer (XeditTextRegion *region)
{
...
static void
xedit_text_region_clear_zero_length_subregions (XeditTextRegion *region)
{
...
void 
xedit_text_region_add (XeditTextRegion     *region,
		     ...
		     const GtkTextIter *_end)
{
	...
	DEBUG (g_print ("---\n"));
	DEBUG (xedit_text_region_debug_print (region));
...
void 
xedit_text_region_subtract (XeditTextRegion     *region,
			  const GtkTextIter *_start,
			  const GtkTextIter *_end)
{
	...
	xedit_text_region_clear_zero_length_subregions (region);

	DEBUG (xedit_text_region_debug_print (region));
}

gint 
xedit_text_region_subregions (XeditTextRegion *region)
{
...
gboolean 
xedit_text_region_nth_subregion (XeditTextRegion *region,
			       guint          subregion,
			       GtkTextIter   *start,
			       GtkTextIter   *end)
{
...
XeditTextRegion * 
xedit_text_region_intersect (XeditTextRegion     *region,
			   const GtkTextIter *_start,
			   const GtkTextIter *_end)
{
	GList *start_node, *end_node, *node;
	...
	new_region = xedit_text_region_new (region->buffer);
	done = FALSE;
...
static gboolean 
check_iterator (XeditTextRegionIteratorReal *real)
{
	if ((real->region == NULL) ||
...
void       
xedit_text_region_get_iterator (XeditTextRegion         *region,
                              XeditTextRegionIterator *iter,
                              guint                  start)
{
	XeditTextRegionIteratorReal *real;

	g_return_if_fail (region != NULL);
	g_return_if_fail (iter != NULL);	

	real = (XeditTextRegionIteratorReal *)iter;
...
gboolean
xedit_text_region_iterator_is_end (XeditTextRegionIterator *iter)
{
	XeditTextRegionIteratorReal *real;
...
gboolean
xedit_text_region_iterator_next (XeditTextRegionIterator *iter)
{
	XeditTextRegionIteratorReal *real;
...
void       
xedit_text_region_iterator_get_subregion (XeditTextRegionIterator *iter,
					GtkTextIter           *start,
					GtkTextIter           *end)
{
	XeditTextRegionIteratorReal *real;
...
void 
xedit_text_region_debug_print (XeditTextRegion *region)
{
	GList *l;
