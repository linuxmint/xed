...
/*
 * Modified by the xedit Team, 2007. See the AUTHORS file for a
...
static void
add_xedit_styles_path (GtkSourceStyleSchemeManager *mgr)
{
	gchar *dir;

	dir = get_xedit_styles_path();
...
GSList *
xedit_style_scheme_manager_list_schemes_sorted (GtkSourceStyleSchemeManager *manager)
{
...
gboolean
_xedit_style_scheme_manager_scheme_is_xedit_user_scheme (GtkSourceStyleSchemeManager *manager,
...
/**
 * _xedit_style_scheme_manager_install_scheme:
 * @manager: a #GtkSourceStyleSchemeManager
 * @fname: the file name of the style scheme to be installed
 *
 * Install a new user scheme.
 * This function copies @fname in #XEDIT_STYLES_DIR and ask the style manager to
 ...
 */
const gchar *
_xedit_style_scheme_manager_install_scheme (GtkSourceStyleSchemeManager *manager,
					    const gchar                 *fname)
{
	...
	styles_dir = get_xedit_styles_path();
	...
	if (strcmp (dirname, styles_dir) != 0)
	{
		...
		/* Copy the style scheme file into XEDIT_STYLES_DIR */
...
/**
 * _xedit_style_scheme_manager_uninstall_scheme:
 * @manager: a #GtkSourceStyleSchemeManager
 ...
 */
gboolean
_xedit_style_scheme_manager_uninstall_scheme (GtkSourceStyleSchemeManager *manager,
					      const gchar                 *id)
{
	GtkSourceStyleScheme *scheme;
	const gchar *filename;
